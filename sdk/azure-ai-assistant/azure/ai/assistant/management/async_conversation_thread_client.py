...
class AsyncConversationThreadClient:
    ...
    def __init_private(
        ...
        self._ai_client : Union[AsyncOpenAIClient, AsyncAzureOpenAIClient] = AIClientFactory.get_instance().get_client(AsyncAIClientType.OPEN_AI, **client_args) if self._ai_client_type is not AsyncAIClientType.AZURE_OPEN_AI and self._ai_client_type is not AsyncAIClientType.OPEN_AI else AIClientFactory.get_instance().get_client(self._ai_client_type, **client_args)
    ...
    async def create_conversation_thread(
        ...
        try:
            ...
            thread = await self._ai_client.create_thread(timeout=timeout)
